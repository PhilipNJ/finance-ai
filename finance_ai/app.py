...
if not is_llm_available():
    print("\n⚠️ LLM dependencies not available (Ollama not reachable).")
...
try:
    ...
    print("\nPlease check:")
    print("  1. Ollama is running and reachable (optional)")
    print("  2. Required Python dependencies are installed")
    print("\n" + "="*70 + "\n")
    raise
